$(document).ready(function() {
    ...
    // <!--Basic Pie echarts init-->
     ...
     option = null;
     option = {
         color: ['#0000FF','#252FA7', '#F44336','#34C73B', '#DCDCDC' ],
         tooltip : {
             trigger: 'item',
    ...
    // <!--Nested Pie echarts init-->
     ...
     option = null;
     option = {
         color: ['#34C73B','#252FA7', '#0000FF','#F44336', '#DCDCDC', '#28D6C3', '#EBCB94', '#EF9688', '#043D5D', '#B8959B' ],
         tooltip : {
             trigger: 'item',
             formatter: '{a} <br/>{b} : {c} ({d}%)'
         },
    ...
    // <!--Doughnut echarts init-->
     ...
     option = null;
     option = {
         color: ['#0000FF','#252FA7', '#F44336','#28D6C3', '#34C73B'],
         tooltip : {
             trigger: 'item',
             formatter: '{a} <br/>{b} : {c} ({d}%)'
         },
